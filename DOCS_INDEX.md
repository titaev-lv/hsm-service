...
- **DOCKER.md**, **DOCKER_COMPOSE.md** - Сохранены для истории, основной документ: DOCKER_DEV.md

---

## 📊 Статистика документации

- **Всего документов**: 18 markdown файлов (корень) + tests/README.md + tests/EXTREME_TEST_RESULTS.md + pki/README.md
