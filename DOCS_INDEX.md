...
6. DEVELOPMENT.md → Как разрабатывать
```
...
5. REVOCATION_RELOAD.md → Отзыв сертификатов
```
...
- **DOCKER.md**, **DOCKER_COMPOSE.md** - Объединены в DOCKER_DEV.md
- **RUN.md** → переименован в **QUICKSTART_NATIVE.md**
- **QUICKSTART.md** → переименован в **QUICKSTART_DOCKER.md**
