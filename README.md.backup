...
**Подробная информация** → см. [QUICKSTART.md](QUICKSTART.md) для первого запуска
...
| [RUN.md](RUN.md) | Инструкции по запуску | 10 мин |
...
| [TECHNICAL_SPEC.md](TECHNICAL_SPEC.md) | Техническая спецификация и детали реализации |
...
| [DOCKER_DEV.md](DOCKER_DEV.md) | Development окружение в Docker |
| [PRODUCTION_DEBIAN.md](PRODUCTION_DEBIAN.md) | Production deployment на Debian 13 + nftables |
...
| [HOT_RELOAD_SUMMARY.md](HOT_RELOAD_SUMMARY.md) | Автоматическая перезагрузка revoked.yaml |
| [REVOCATION_RELOAD.md](REVOCATION_RELOAD.md) | Механизм отзыва сертификатов |
...
| Документ | Описание |
|----------|----------|
| [MONITORING.md](MONITORING.md) | Prometheus + Grafana мониторинг |
...
| [TEST_PLAN.md](TEST_PLAN.md) | Комплексный план тестирования |
